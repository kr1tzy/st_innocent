"""
    st_innocent/api/routes/images.py
"""
...
from api.models import File, FileResponse, JSONException
...
async def upload_image(
    ...
    try:
        ...
        await new_image.set(
            {
                File.admin_url: f"http://{settings.host}:{settings.api_port}/images/{new_image.id}?raw=true"
